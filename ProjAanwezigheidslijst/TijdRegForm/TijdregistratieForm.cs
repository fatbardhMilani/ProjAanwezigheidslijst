...
namespace TijdRegForm
{
    public partial class TijdregistratieForm : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (var context = new AanwezigheidslijstContext())
            {
                var dln = context.Opleidingsinformaties.SingleOrDefault(d => d.Opleiding == selectOpl);
            ...
            using (var context = new AanwezigheidslijstContext())
            {
                var deelnemer = context.Opleidingsinformaties.SingleOrDefault(dlnmr => dlnmr.Opleiding == selectOpl);
